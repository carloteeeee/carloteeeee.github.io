...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 10) return '赶紧退学吧！';
    if (score <= 50) return '真不理解十字基地招生标准怎么低成这样了！';
    if (score <= 100) return '就这么点水平，还不好好努力？！';
    if (score <= 150) return '勉勉强强，还算过得去吧。';
    return '戒骄戒躁，小心驶得万年船，哪天要是栽跟头了可别说本导师没提醒过你！';
}
